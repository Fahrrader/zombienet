import { ChainSpec, Command, ComputedNetwork, HrmpChannelsConfig, Node } from "./types";
export declare function destroyChainSpecProcesses(): Promise<void>;
...
export declare function runCommandWithChainSpec(chainSpecFullPath: string, commandWithArgs: Command, workingDirectory: string | URL): Promise<void>;
